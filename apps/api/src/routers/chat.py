...
from ai_core import get_provider, LLMConfig
...
class ChatPromptRequest(BaseModel):
    ...
    provider: Optional[str] = Field(default="gemini", description="AI provider name (gemini, openai, mock)")
...
@router.post("/stream")
async def stream_chat(request: ChatPromptRequest):
    """
