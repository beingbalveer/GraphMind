...
export function SidePeekBranchSheet({
  ...
  const currentEntry = historyStack[historyIndex] || null;
  ...
  if (!isOpen || !currentEntry || !currentNodeId) return null;
  ...
  return (
    <aside
      className="fixed inset-y-0 right-0 z-40 w-full sm:w-[480px] md:w-[540px] lg:w-[580px] bg-white border-l border-zinc-200/90 shadow-2xl flex flex-col animate-in slide-in-from-right duration-250 font-sans select-text"
    >
