              ...
              {workspaces.map((ws) => (
                ...
                >
                  <div className="flex items-start justify-between w-full mb-3">
                    <h3 className="font-semibold text-foreground group-hover:text-primary transition-colors truncate pr-4">
                      {ws.name}
                    </h3>
                  </div>
                  {ws.description && (
                  ...
                  <div className="mt-auto pt-4 flex items-center justify-between text-xs text-foreground-muted border-t border-border-subtle w-full">
